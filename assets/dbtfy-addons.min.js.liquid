(function() {
  ...
  /* start-dbtfy-cart-favicon */ function themeCartFavicon(){ {%- if settings.dbtfy_cart_favicon -%} function CartFavicon(t){const e=t?t.item_count:theme.variables.cartCount;if(""!==theme.settings.cartFaviconImage){const t=document.getElementById("favicon");e>0?t.setAttribute("href",theme.settings.cartFaviconImage):t.setAttribute("href",theme.settings.faviconImage)}}CartFavicon(),$("body").on("ajaxCart.afterCartLoad",function(t,e){CartFavicon(e)}); {%- endif -%} } /* end-dbtfy-cart-favicon */
